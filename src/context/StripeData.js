...
const loginUser = async () => {
    ...
    try{
    const response = await fetch("https://backendyttt.onrender.com/auth/user/loginuser", {
        method: 'POST',
        headers: {
...
const AddUser = async () => {
  ...
  const response = await fetch("https://backendyttt.onrender.com/auth/user/adduser", {
  ...
  const addPlan = async (plantype, hardware,price,time,date) => {
    try{
      const response = await fetch("https://backendyttt.onrender.com/auth/stripe/addplan", {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
...
const fetchplan = async () => {
  const response = await fetch("https://backendyttt.onrender.com/auth/stripe/fetchplan", {
    method: 'GET',
    headers: {
      'Content-Type': 'application/json',
      'auth-token': localStorage.getItem('token')
